    ...
    return (
       <div>
        <div className=" flex justify-center">
            <p className=" btn btn-sm text-yellow-500 my-5">Donation Page</p>
        </div>
         <form onSubmit={handelDonate} className="w-11/12 md:w-2/5 lg:w-1/3 mx-auto my-7">
            ...
            <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mb-5">Donate Books</button>
        </form>
       </div>
    );
};
